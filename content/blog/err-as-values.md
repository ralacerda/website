...
- O que é um erro, o que é uma falha e o que é uma exceção?
  ...
  E no começo pode parecer estranho, afinal, chamar de "Erro" pode parecer muito, mas na verdade,
  tudo depende de como você lida. Entretanto, o legal dessa situação
  é que temos todas as ferramentas de abstrações ao seu dispor, por exemplo,
  você pode criar um tipo de erro para erros fatais, e outro tipo para erros mais "leves" e esperados
